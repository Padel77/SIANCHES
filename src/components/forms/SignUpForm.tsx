...
export default function SignUpForm() {
    ...
    const handleChecked = useCallback((e: any) => setChecked(!checked), [checked])
    return (
        <main className="container h-full w-full flex items-center flex-col justify-center gap-4">
            ...
            >
                ...
                <div className="flex items-center space-x-2" >
                    <Checkbox id='checkbox' required checked={checked} onCheckedChange={handleChecked} />
                    <Label htmlFor="checkbox"><span className="text-gray-300">Agree to the</span> terms and conditions</Label>
                </div>
