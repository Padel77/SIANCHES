...
export default function CommonDialog({ text, DialogForm, importReport = true }) {
    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <Button onClick={handleOpen} className="bg-custom-gradient text-white capitalize flex items-center gap-2  font-light">
                {text}
